...
from patrimonio.db.dao.dummy_dao import DummyDAO
from patrimonio.db.models.dummy_model import DummyModel
from patrimonio.web.api.dummy.schema import DummyModelDTO, DummyModelInputDTO
